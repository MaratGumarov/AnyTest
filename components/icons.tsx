...
export const LoadingSpinner: React.FC<{ className?: string, textClassName?: string }> = ({ className, textClassName = "text-indigo-600 dark:text-indigo-400" }) => (
  <svg 
    className={`animate-spin h-5 w-5 ${textClassName} ${className || ''}`} 
